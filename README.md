...
- [ptsematest](https://manpages.ubuntu.com/manpages/noble/en/man8/ptsematest.8.html) - Works for values of `--threads` smaller than 8. For bigger values, install the snap in [devmode](https://snapcraft.io/docs/install-modes#heading--devmode); see [#46](https://github.com/canonical/rt-tests-snap/issues/46)
